 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct=globalThis;class Q extends qt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var r;const t=super.createRenderRoot();return(r=this.renderOptions).renderBefore??(r.renderBefore=t.firstChild),t}update(t){const r=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=hl(r,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return Yt}}var To;Q._$litElement$=!0,Q.finalized=!0,(To=Ct.litElementHydrateSupport)==null||To.call(Ct,{LitElement:Q});const oa=Ct.litElementPolyfillSupport;oa==null||oa({LitElement:Q});(Ct.litElementVersions??(Ct.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`}_getMeal(e,t){var r,i;return(i=(r=this._plan)==null?void 0:r.meals)==null?void 0:i.find(a=>a.dayOfWeek===e&&a.mealType===t)}_renderMobileList(){return Ma.map((e,t)=>{const r=t+1,i=this._expandedDay===r,a=Ca.map(n=>({type:n,meal:this._getMeal(r,n.value)}));return d`
      ...
      ${!e&&!this._editMode?d`
        ...
        `:d`
          <div class="desktop-grid">
            ...
            ${Ma.map(n=>d`<div class="header-cell">${n}</div>`)}
      ...
      ${this._showPanel?d`
        ...
        <div class="panel">
          ...
          <div class="panel-context">
            ${Ma[this._panelDay-1]}, ${(i=Ca.find(n=>n.value===this._panelMealType))==null?void 0:i.label}
